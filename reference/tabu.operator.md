...
- tabu.control:
  ...
  [`tabuControl`](https://nlmixr2auto.org/reference/tabuControl.md):
...
[`tabuControl`](https://nlmixr2auto.org/reference/tabuControl.md) for
control parameters,
[`detect_move`](https://nlmixr2auto.org/reference/detect_move.md) for
move detection,
[`is_move_tabu`](https://nlmixr2auto.org/reference/is_move_tabu.md) for
tabu checking,
[`perturb_2bit`](https://nlmixr2auto.org/reference/perturb_2bit.md) for
perturbation
